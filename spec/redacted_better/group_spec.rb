...
describe Group do
  ...
  describe "#formats_missing" do
    it "gets the missing formats" do
      ...
      create(:torrent, group: group, format: "MP3", encoding: "320", media: flac.media, remaster_year: flac.remaster_year, remaster_title: flac.remaster_title, remaster_record_label: flac.remaster_record_label, remaster_catalogue_number: flac.remaster_catalogue_number)
