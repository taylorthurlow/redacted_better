class Group
  ...
  #
  # @param torrent [Torrent] The torrent to identify which release group we are
  #   looking to query. A group may contain many release groups, and we need
  #   one torrent from that group to find the specific release group.
  #
